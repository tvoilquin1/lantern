...
- **Biweekly baseline re-screen:** 8 conversational items total — 7 domain items (0–4 each, co-founder-authored and clinically approved 2026-09-06; now covering all five LCWS domains) plus 1 global summary item ("Overall burden", scored 0–4 separately as a cross-check); Finances item captain-added with clinical co-founder agreement — see LCWS doc for the full set
